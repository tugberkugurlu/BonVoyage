...
{
    /// <remarks>
    /// Nicked from https://github.com/ASP-NET-MVC/aspnetwebstack/blob/master/src/System.Net.Http.Formatting/HttpClientFactory.cs
    /// </remarks>
    internal static class HttpClientFactory
    {
        ...
        public static HttpMessageHandler CreatePipeline(HttpMessageHandler innerHandler, IEnumerable<DelegatingHandler> handlers)
        {
            ...
            foreach (DelegatingHandler handler in reversedHandlers)
            {
                if (handler == null)
                {
                    throw new ArgumentException("DelegatingHandlerArrayContainsNullItem", nameof(handlers));
                }

                if (handler.InnerHandler != null)
                {
                    throw new ArgumentException("DelegatingHandlerArrayHasNonNullInnerHandler", nameof(handlers));
                }
